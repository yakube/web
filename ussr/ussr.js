...
function draw() {
  ...
  }else if(lives>900)
  {
    ...
    textSize(48);
    textAlign(CENTER);
    text("You destroyed "+score+" capitalist devils",1920/2,(1080/2)-100);
    text("Rest in Peace, Soviet Union",1920/2,(1080/2)-30);
    text("(30 December 1922 - "+arbor.value.date+")",1920/2,(1080/2)+40);
    text("[F5] Play Again", 1920/2, 100+3*1080/4);
  ...
  textSize(40);
  fill(255);
  text("Сегодня утром я пил водку",1920/2,125+1080/5);//This morning I was drinking vodka
  text("Потом все закончилось",1920/2,175+1080/5);//Then it ran dry
  text("Я спросила бабушку, где я могу найти еще водки",1920/2,225+1080/5);//I asked my grandmother where I can find more vodka
  text("Она сказала, что это было в космосе",1920/2,275+1080/5);//She said it was in outer space
  text("Теперь я сталкиваюсь с капиталистическими дьяволами",1920/2,325+1080/5);//Now I encounter capitalist devils
  text("Я буду защищать СССР любой ценой.",1920/2,375+1080/5);//I will defend the USSR at all costs
  textSize(80);
  fill(255,0,0);
  text("Республика не падет",1920/2,475+1080/5);//The republic will not fall
  textAlign(LEFT,BASELINE);
  strokeWeight(4);
  fill(255,0,0);
  textAlign(CENTER,CENTER);
  rectMode(CENTER);
  rect(1920/2,3*1080/4+120,300,60);
  fill(255,255,0);
  textSize(40);
  text("[F11] Fullscreen", 1920/2, 3*1080/4+120);
  rectMode(CORNER);
  textAlign(LEFT,BASELINE);
  strokeWeight(4);
  }
...
if (shot>= 6-(bench-48*(level-1))/9.6)
{
  if (enemies.length>0)//notify shot avail
  {
    ...
    fill(255,255,0);
    stroke(100,0,0);
    text("[B] Soviet Scattershot", 1450, 950);
    stroke(0);
  }
   else//notify point bonus
  {
    ...
    fill(200, 200, 50);
    if (shot==5)
      text("+50 Proletariat Bonus", 1450, 950);
    else
      text("+"+(5*shot)+" Proletariat Bonus", 1450, 950);
  }
}
textSize(40);
fill(255, 255, 0);
...
{
  fill(255,255,0,15+frameTimer*3);
